...
"/c/Program Files/Java/jdk1.8.0_101/bin/"jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore $NOMBREKEYSTORE.keystore -storepass $PASSKEYSTORE  ~/Documents/GitHub/$PROYECTO/platforms/android/app/build/outputs/apk/release/app-release-unsigned.apk $ALIASKEYSTORE
echo "******************************"
